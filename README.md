...
欢迎使用杰理AC79开源项目，在开始进入项目之前，请详细阅读以下芯片介绍获得对AC79系列芯片大概认识，SDK固件包不含开发文档，进行开发之前详细阅读SDK开发文档:[https://doc.zh-jieli.com/AC79/zh-cn/release_v1.1.0/index.html](https://doc.zh-jieli.com/AC79/zh-cn/release_v1.1.0/index.html)，为用户提供完善的开发例程，帮助开发者快速顺利地使用AC79系列芯片进行方案开发。
