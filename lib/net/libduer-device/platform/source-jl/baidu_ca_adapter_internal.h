...
extern duer_thread_t duer_adp_thread_create(char *name, duer_u8_t priority, duer_u32_t stack_size,
        duer_bool is_static, cpu_core_id_t core_id);

extern duer_status_t thread_start(duer_thread_t thread, duer_thread_entry_f_t entry_func,
                                  void *args);

extern duer_status_t thread_exit(duer_thread_entry_args_t *entry_args, duer_bool is_released);

extern duer_status_t thread_destroy(duer_thread_t thread);

extern duer_u32_t thread_get_id(duer_thread_t thread);

extern duer_status_t thread_get_stack_info(duer_thread_t thread);
