...
#ifdef MBEDTLS_V_3_4_0
    if (mbedtls_rsa_pkcs1_encrypt(&rsa, _rand, NULL, in_size,
...
#ifdef MBEDTLS_V_3_4_0
    if (mbedtls_rsa_pkcs1_decrypt(&rsa, _rand, NULL, (size_t *)&len,
...
#ifdef MBEDTLS_V_3_4_0
    if (mbedtls_rsa_pkcs1_encrypt(&rsa, _rand, NULL, PT_LEN,
...
#ifdef MBEDTLS_V_3_4_0
    if (mbedtls_rsa_pkcs1_decrypt(&rsa, _rand, NULL, &len,
