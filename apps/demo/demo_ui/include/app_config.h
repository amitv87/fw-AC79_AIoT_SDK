...
#define CONFIG_JL_AC79_DevKitboard //需要注意791系列摄像头驱动多了一个配置参数 .sync_config
...
// #define CONFIG_OVERCLOCKING_ENABLE
...
/* #define UI_DEMO_0_UI_TEMPLATE   //ui示例工程                //使用0.ui_template ui工程 */
...
//#define USE_UGFX_UI_DEMO
//#define USE_GUIX_UI_DEMO
...
#define UI_AUTO_MAKE_PROJECT //自动生成ui资源文件并自动开打ui工程 需要事前准备好jl UI工程
#define UI_PROJECT_PATH "\ui_project\0.ui_template\ui_320x480_test\project"
#endif

#ifdef UI_DEMO_1_0
#define UI_AUTO_MAKE_PROJECT //自动生成ui资源文件并自动开打ui工程 需要事前准备好jl UI工程
#define UI_PROJECT_PATH "\ui_project\1.ui_demo_1\ui_320x480_test\project"
#endif
...
#if defined USE_LVGL_UI_DEMO || defined USE_AWTK_UI_DEMO
