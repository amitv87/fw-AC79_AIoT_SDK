...
#else
static int video_rec_finish_notify(char *path)
{
    return 0;
}
static int video_rec_delect_notify(FILE *fd, int id)
{
    return 0;
}
static int video_rec_err_notify(const char *method)
{
    return 0;
}
static int video_rec_state_notify(void)
{
    return 0;
}
static int video_rec_start_notify(void)
{
    return 0;
}
static int video_rec_all_stop_notify(void)
{
    return 0;
}
static int net_video_rec_event_notify(void)
{
    return 0;
}
static int net_video_rec_event_stop(void)
{
    return 0;
}
static int net_video_rec_event_start(void)
{
    return 0;
}
static char *get_net_video_rec0_video_buf(int *buf_size)
{
    *buf_size = 0;
    return NULL;
}
static char *get_net_video_rec1_video_buf(int *buf_size)
{
    *buf_size = 0;
    return NULL;
}
static char *get_net_video_rec2_video_buf(int *buf_size)
{
    *buf_size = 0;
    return NULL;
}
static char *get_net_video_rec_audio_buf(int *buf_size)
{
    *buf_size = 0;
    return 0;
}
static char *get_net_video_isc_buf(int *buf_size)
{
    *buf_size = 0;
    return NULL;
}
static void net_video_server_init(void)
{
}
static void net_video_event_hander(void *e)
{
}
#endif
...
#endif
#ifdef CONFIG_UI_ENABLE
    os_taskq_post("ui_demo", 1, UI_EVENT_COMPLETE_RECORD);
