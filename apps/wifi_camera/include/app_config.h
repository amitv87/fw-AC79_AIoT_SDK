...
//需要自行下载sdk目录下/ui_project/文件夹中的路径文件放到该文件夹下
#define UI_AUTO_MAKE_PROJECT           //使用wifi_camera_ui工程 该宏会在download.c进行调用 批处理自动生成UI资源文件
#ifdef UI_AUTO_MAKE_PROJECT
#define UI_PROJECT_PATH "\ui_project\3.ui_demo_wifi_camera\ui_320x480_test\project"
#endif
