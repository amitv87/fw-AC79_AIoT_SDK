...
// *INDENT-OFF*
#define DEBUG_IO	TCFG_DEBUG_PORT
...
SW_IIC_PLATFORM_DATA_BEGIN(sw_iic0_data)
	.clk_pin = TCFG_IIC0_CLK,
	.dat_pin = TCFG_IIC0_DAT,
    .sw_iic_delay = 50,
...
#endif
    .port   = 'C',
    .attr	= TCFG_SPI_ATTR,//从机，CLK低 更新数据低，单向模式
...
static const struct camera_platform_data camera0_data = {
    .xclk_gpio      = TCFG_VIDEO0_CAMERA_XCLOCK,//注意： 如果硬件xclk接到芯片IO，则会占用OUTPUT_CHANNEL1
...
static const struct camera_platform_data camera1_data = {
    .xclk_gpio      = TCFG_VIDEO1_CAMERA_XCLOCK,//IO_PORTB_02,//IO_PORTC_08,//IO_PORTC_06,//注意： 如果硬件xclk接到芯片IO，则会占用OUTPUT_CHANNEL1
    ...
    .dvp={
        .group_port  = CAMERA1_GROUP_PORT,
#if (CAMERA1_GROUP_PORT == ISC_GROUPA)
		.pclk_gpio   = IO_PORTA_08,
#elif (CAMERA1_GROUP_PORT == ISC_GROUPC)
		.pclk_gpio   = IO_PORTC_08,
#endif
		.hsync_gpio  = -1,
		.vsync_gpio  = -1,
...
static const struct otg_dev_data otg_data = {
    .usb_dev_en = (TCFG_HUSB_EN << 1) | TCFG_FUSB_EN,
