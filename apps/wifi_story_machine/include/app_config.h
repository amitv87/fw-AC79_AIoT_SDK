...
#define CONFIG_BT_RX_BUFF_SIZE  (8 * 1024 * TCFG_BD_NUM)
#define CONFIG_BT_TX_BUFF_SIZE  ((6 * 1024 - 512) * TCFG_BD_NUM)
#else
#define CONFIG_BT_RX_BUFF_SIZE  ((11 * 1024 - 512) * TCFG_BD_NUM)
