...
#define BYD20A6_OUT_DVP		0//0:spi-bt656 , 1:dvp-yuv

#if !BYD20A6_OUT_DVP //开启单线则使用video1
#ifdef CONFIG_VIDEO1_ENABLE /*开启video1则使用video1分辨率*/
#undef BYD20A6_DEVP_INPUT_W
#undef BYD20A6_DEVP_INPUT_H
#define BYD20A6_DEVP_INPUT_W CONFIG_VIDEO1_IMAGE_W
#define BYD20A6_DEVP_INPUT_H CONFIG_VIDEO1_IMAGE_H
#endif
#endif
...
static const struct reginfo sensor_init_data[] = {
    ...
    {0x3a, 0x01},
    {0xe1, 0xd3},
    {0xe3, 0x31},//33M //使用内部PLL，PLL时钟不太正常，33M以上无法收到
    /*{0xe3, 0x82},//24M//使用xclk时钟源*/
    {0x12, 0x10},
    {0x15, 0x90},
    {0x16, 0x73},
    ...
    {0xe6, 0x24},
    {0xe7, 0x64},
    {0xe8, 0xf7}, //[0:1]VDDIO强驱, 00:1.7v, 01:1.8v, 10:1.9v, 11:2.0v
    {0x4a, 0x00},
    {0x00, 0x03},
    {0x1f, 0x02},
    {0x22, 0x02},
