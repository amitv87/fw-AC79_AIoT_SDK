...
#if defined CONFIG_ASR_ALGORITHM || defined CONFIG_REVERB_MODE_ENABLE || defined CONFIG_AEC_ENC_ENABLE || defined CONFIG_DNS_ENC_ENABLE || defined CONFIG_M4A_DEC_ENABLE || defined CONFIG_WMA_DEC_ENABLE || defined CONFIG_SPECTRUM_FFT_EFFECT_ENABLE
...
sec(.fft_data) static int datain_y[0];
#else
sec(.fft_data) static int datain[MAX_FFT_SUPPORT_POINT_NUM];
sec(.fft_data) static int dataout[MAX_FFT_SUPPORT_POINT_NUM + 2];
sec(.fft_data) static int datain_y[0];
