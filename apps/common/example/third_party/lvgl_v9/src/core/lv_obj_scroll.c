...
{
    if (obj->spec_attr) {
        return (lv_scrollbar_mode_t) obj->spec_attr->scrollbar_mode;
    } else {
...
{
    if (obj->spec_attr) {
        return (lv_dir_t) obj->spec_attr->scroll_dir;
    } else {
        return LV_DIR_ALL;
    }
}
...
{
    if (obj->spec_attr) {
        return (lv_scroll_snap_t) obj->spec_attr->scroll_snap_x;
    } else {
...
{
    if (obj->spec_attr) {
        return (lv_scroll_snap_t) obj->spec_attr->scroll_snap_y;
    } else {
        return LV_SCROLL_SNAP_NONE;
    }
}
