        ...
        int32_t len)
{
    ...
    for (i = 0; masks[i]; i++) {
        ...
        } else if (res == LV_DRAW_SW_MASK_RES_CHANGED) {
            changed = true;
        }
    }
                                      ...
                                      int32_t p2y, lv_draw_sw_mask_line_side_t side)
{
    ...
    if (param->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_LEFT) {
        param->inv = 0;
    } else if (param->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_RIGHT) {
        param->inv = 1;
                                 ...
                                 bool inv)
{
    ...
    for (i = 0; i < LV_DRAW_SW_CIRCLE_CACHE_SIZE; i++) {
        if (_circle_cache[i].used_cnt == 0) {
            ...
            } else if (_circle_cache[i].life < entry->life) {
                entry = &(_circle_cache[i]);
            }
        }
    }
    ...
    if (p->steep == 0) {
        ...
        if (p->flat) {
            ...
            if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_LEFT ||
                p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_RIGHT) {
                return LV_DRAW_SW_MASK_RES_FULL_COVER;
            } else if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_TOP && abs_y < 0) {
                return LV_DRAW_SW_MASK_RES_FULL_COVER;
            } else if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_BOTTOM && abs_y > 0) {
                return LV_DRAW_SW_MASK_RES_FULL_COVER;
            } else {
                return LV_DRAW_SW_MASK_RES_TRANSP;
            }
        ...
        /*Vertical*/
            ...
            if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_TOP ||
                p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_BOTTOM) {
                return LV_DRAW_SW_MASK_RES_FULL_COVER;
            } else if (p->cfg.side == LV_DRAW_SW_MASK_LINE_SIDE_RIGHT && abs_x > 0) {
                return LV_DRAW_SW_MASK_RES_FULL_COVER;
        ...
        lv_draw_sw_mask_angle_param_t *p)
{
    ...
    if (p->cfg.start_angle < 180 && p->cfg.end_angle < 180 &&
        ...
        if (p->cfg.start_angle == 180) {
            if (abs_y < p->cfg.vertex_p.y) {
                res1 = LV_DRAW_SW_MASK_RES_FULL_COVER;
            } else {
        ...
        if (p->cfg.end_angle == 180) {
            if (abs_y < p->cfg.vertex_p.y) {
                ...
                res2 = LV_DRAW_SW_MASK_RES_FULL_COVER;
            }
        ...
        if (res1 == LV_DRAW_SW_MASK_RES_TRANSP || res2 == LV_DRAW_SW_MASK_RES_TRANSP) {
            return LV_DRAW_SW_MASK_RES_TRANSP;
        } else if (res1 == LV_DRAW_SW_MASK_RES_UNKNOWN && res2 == LV_DRAW_SW_MASK_RES_UNKNOWN) {
            return LV_DRAW_SW_MASK_RES_TRANSP;
