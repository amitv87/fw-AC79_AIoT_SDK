...
#if defined(TCFG_AUDIO_OUT_EQ_ENABLE) && TCFG_AUDIO_OUT_EQ_ENABLE
...
int get_module_name(u16 group_id, u8 tar)
{
    ...
    log_error("%s error id 0x%x, tar %d\n", __func__, group_id, tar);
    return 0;
}
