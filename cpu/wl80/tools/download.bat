...
isd_download.exe isd_config.ini -tonorflash -dev wl80 -boot 0x1c02000 -div1 -wait 300 -uboot uboot.boot -app app.bin cfg_tool.bin -res audlogo ui_res cfg -reboot 500 %KEY_FILE% -update_files normal
