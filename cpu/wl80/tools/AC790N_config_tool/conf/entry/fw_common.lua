...
dms_reference_book_path = projdir .. '/doc/JL DMS通话调试手册.pdf';
anc_reference_book_path = projdir .. '/doc/JL_AC700N_ANC调试手册.pdf';
...
dms_reference_book_path = download_path .. 'JL DMS通话调试手册.pdf';
anc_reference_book_path = download_path .. 'JL ANC通话调试手册.pdf';
