...
for i = 1, 20 do
	local c = cfg:str("蓝牙名字" .. i, "AC79_" .. i);
	local on = 0;
...
-- item_htext
aec_global.ndt_max_gain.comment_str = "设置范围：0 ~ 24 dB, 默认值：12.0 dB";
...
aec_global.ndt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_global.ndt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
...
-- item_htext
aec_global.ndt_min_gain.comment_str = "设置范围：-20 ~ 24 dB, 默认值：0 dB";
...
aec_global.ndt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_global.ndt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
...
-- item_htext
aec_global.dt_max_gain.comment_str = "设置范围：0 ~ 24.0 dB, 默认值：12.0 dB";
...
aec_global.dt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_global.dt_max_gain.cfg, 0, 24.0, 0.1, 1),
...
-- item_htext
aec_global.dt_min_gain.comment_str = "设置范围：-20.0 ~ 24.0 dB, 默认值：0 dB";
...
aec_global.dt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_global.dt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
...
dms_global.dms_aec_mode.aec_en = cfg:enum("AEC_EN:", ENABLE_SWITCH, 0);
depend_item_en_show(bluetooth_en, dms_global.dms_aec_mode.aec_en);

dms_global.dms_aec_mode.nlp_en = cfg:enum("NLP_EN:", ENABLE_SWITCH, 1);
depend_item_en_show(bluetooth_en, dms_global.dms_aec_mode.nlp_en);

dms_global.dms_aec_mode.ans_en = cfg:enum("ANS_EN:", ENABLE_SWITCH, 1);
depend_item_en_show(bluetooth_en, dms_global.dms_aec_mode.ans_en);

dms_global.dms_aec_mode.enc_en = cfg:enum("ENC_EN:", ENABLE_SWITCH, 1);
depend_item_en_show(bluetooth_en, dms_global.dms_aec_mode.enc_en);

dms_global.dms_aec_mode.agc_en = cfg:enum("AGC_EN:", ENABLE_SWITCH, 1);
...
dms_global.dms_aec_mode.hbox_view = cfg:hBox {
	...
	cfg:enumView(dms_global.dms_aec_mode.aec_en),

    --cfg:stLabel(TAB_TABLE[1]),
    cfg:stLabel(" "),

    cfg:stLabel(dms_global.dms_aec_mode.nlp_en.name),
	cfg:enumView(dms_global.dms_aec_mode.nlp_en),
    cfg:stLabel(" "),

    --cfg:stLabel(TAB_TABLE[1]),

    cfg:stLabel(dms_global.dms_aec_mode.ans_en.name),
	cfg:enumView(dms_global.dms_aec_mode.ans_en),
    cfg:stLabel(" "),

    --cfg:stLabel(TAB_TABLE[1]),

    cfg:stLabel(dms_global.dms_aec_mode.enc_en.name),
	cfg:enumView(dms_global.dms_aec_mode.enc_en),
    cfg:stLabel(" "),

    cfg:stLabel(dms_global.dms_aec_mode.agc_en.name),
	cfg:enumView(dms_global.dms_aec_mode.agc_en),
    --cfg:stLabel(TAB_TABLE[1]),
    cfg:stLabel(" "),
...
dms_global.dms_agc.dms_ndt_max_gain.cfg = cfg:dbf("NDT_MAX_GAIN:  ", 12.0);
...
dms_global.dms_agc.dms_ndt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_global.dms_agc.dms_ndt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};

-- 5-6) dms_ndt_min_gain
dms_global.dms_agc.dms_ndt_min_gain.cfg = cfg:dbf("NDT_MIN_GAIN:  ", 0.0);
...
dms_global.dms_agc.dms_ndt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_global.dms_agc.dms_ndt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
dms_global.dms_agc.dms_dt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_global.dms_agc.dms_dt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};
...
dms_global.dms_agc.dms_dt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_global.dms_agc.dms_dt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
dms_global.dms_enc.dms_mic_distance.hbox_view = cfg:hBox {
    cfg:stLabel(dms_global.dms_enc.dms_mic_distance.cfg.name),
    cfg:dspinView(dms_global.dms_enc.dms_mic_distance.cfg, 0.015, 0.035, 0.001, 3),
    cfg:stLabel("(设置范围: 0.015 ~ 0.035，默认值：0.015，单位:mm)"),
    cfg:stSpacer(),
};
...
aec_dns_global.ndt_max_gain.cfg = cfg:dbf("AEC_DNS_NDT_MAX_GAIN：", 12.0);
depend_item_en_show(bluetooth_en, aec_dns_global.ndt_max_gain.cfg);
aec_dns_global.ndt_max_gain.cfg:setOSize(4);
-- item_htext
aec_dns_global.ndt_max_gain.comment_str = "设置范围：0 ~ 24 dB, 默认值：12.0 dB";
...
aec_dns_global.ndt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_dns_global.ndt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};
...
aec_dns_global.ndt_min_gain.cfg = cfg:dbf("ANS_DNS_NDT_MIN_GAIN：", 0.0);
depend_item_en_show(bluetooth_en, aec_dns_global.ndt_min_gain.cfg);
aec_dns_global.ndt_min_gain.cfg:setOSize(4);
-- item_htext
aec_dns_global.ndt_min_gain.comment_str = "设置范围：-20 ~ 24 dB, 默认值：0 dB";
...
aec_dns_global.ndt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_dns_global.ndt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
-- item_htext
aec_dns_global.dt_max_gain.comment_str = "设置范围：0 ~ 24.0 dB, 默认值：12.0 dB";
...
aec_dns_global.dt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_dns_global.dt_max_gain.cfg, 0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大上限， 设置范围: 0 ~ 24.0 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};
...
-- item_htext
aec_dns_global.dt_min_gain.comment_str = "设置范围：-20.0 ~ 24.0 dB, 默认值：0 dB";
...
aec_dns_global.dt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_dns_global.dt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
aec_dns_global.dns_aggress.cfg = cfg:dbf("AEC_DNS_DNS_AGGRESS：", 0.1);
...
aec_dns_global.dns_aggress.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_dns_global.dns_aggress.cfg, 0.0, 1.0, 0.01, 2),
...
aec_dns_global.dns_suppress.cfg = cfg:dbf("AEC_DNS_DNS_SUPPRESS：", 1.0);
...
aec_dns_global.dns_suppress.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(aec_dns_global.dns_suppress.cfg, 0.0, 6.0, 0.1, 1),
...
-- 5-5) dms_ndt_max_gain
dms_dns_global.dms_agc.dms_ndt_max_gain.cfg = cfg:dbf("DMS_DNS_NDT_MAX_GAIN:  ", 12.0);
...
dms_dns_global.dms_agc.dms_ndt_max_gain.hbox_view = cfg:hBox {
    cfg:stLabel("NDT_MAX_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_dns_global.dms_agc.dms_ndt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};

-- 5-6) dms_ndt_min_gain
dms_dns_global.dms_agc.dms_ndt_min_gain.cfg = cfg:dbf("DMS_DNS_NDT_MIN_GAIN:  ", 0.0);
...
dms_dns_global.dms_agc.dms_ndt_min_gain.hbox_view = cfg:hBox {
    cfg:stLabel("NDT_MIN_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_dns_global.dms_agc.dms_ndt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
dms_dns_global.dms_agc.dms_dt_max_gain.hbox_view = cfg:hBox {
    cfg:stLabel("DT_MAX_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_dns_global.dms_agc.dms_dt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};
...
dms_dns_global.dms_agc.dms_dt_min_gain.hbox_view = cfg:hBox {
    cfg:stLabel("DT_MIN_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_dns_global.dms_agc.dms_dt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
-- 8-1) dns_aggress
dms_dns_global.dms_ans.dns_aggress.cfg= cfg:dbf("DMS_DNS_DNS_AGGRESS:  ", 0.1);
...
dms_dns_global.dms_ans.dns_aggress.hbox_view = cfg:hBox {
    cfg:stLabel("DNS_GainFloor：" .. TAB_TABLE[1]),
    cfg:dspinView(dms_dns_global.dms_ans.dns_aggress.cfg, 0.0, 1.0, 0.01, 2),
...
-- 8-2) dns_suppress
dms_dns_global.dms_ans.dns_suppress.cfg= cfg:dbf("DMS_DNS_DNS_SUPPRESS：", 1.0);
...
dms_dns_global.dms_ans.dns_suppress.hbox_view = cfg:hBox {
    cfg:stLabel("DNS_OverDrive：" .. TAB_TABLE[1]),
    cfg:dspinView(dms_dns_global.dms_ans.dns_suppress.cfg, 0.3, 6.0, 0.1, 1),
    cfg:stLabel("(降噪强度,越大降噪越强，设置范围: 0.3 ~ 6.0，默认值：1.0)"),
    cfg:stSpacer(),
};

dms_dns_global.dms_ans.pad.cfg = cfg:dbf("DMS_DNS_DNS_PAD: ", 0);
dms_dns_global.dms_ans.pad.cfg:setOSize(4);
...
dms_dns_global.dms_common.global_minsuppress.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_dns_global.dms_common.global_minsuppress.cfg, 0.0, 0.09, 0.01, 2),
    cfg:stLabel("(设置范围: 0.0 ~ 0.09，默认值：0.04)"),
    cfg:stSpacer(),
};
...
dms_dns_global.dms_item_table = {
    -- aec cfg
        ...
        dms_dns_global.dms_ans.pad.cfg, -- 4 Bytes
...
dms_flexible_global.dms_aec_mode.aec_en = cfg:enum("DMS_FLEXIBLE_AEC_EN:", ENABLE_SWITCH, 0);
depend_item_en_show(bluetooth_en, dms_flexible_global.dms_aec_mode.aec_en);

dms_flexible_global.dms_aec_mode.nlp_en = cfg:enum("DMS_FLEXIBLE_NLP_EN:", ENABLE_SWITCH, 1);
depend_item_en_show(bluetooth_en, dms_flexible_global.dms_aec_mode.nlp_en);

dms_flexible_global.dms_aec_mode.ans_en = cfg:enum("DMS_FLEXIBLE_ANS_EN:", ENABLE_SWITCH, 1);
depend_item_en_show(bluetooth_en, dms_flexible_global.dms_aec_mode.ans_en);

dms_flexible_global.dms_aec_mode.enc_en = cfg:enum("DMS_FLEXIBLE_ENC_EN:", ENABLE_SWITCH, 1);
depend_item_en_show(bluetooth_en, dms_flexible_global.dms_aec_mode.enc_en);

dms_flexible_global.dms_aec_mode.agc_en = cfg:enum("DMS_FLEXIBLE_AGC_EN:", ENABLE_SWITCH, 1);
...
dms_flexible_global.dms_aec_mode.hbox_view = cfg:hBox {
    ...
    --cfg:stLabel("AEC_EN:"),
	--cfg:enumView(dms_flexible_global.dms_aec_mode.aec_en),

    --cfg:stLabel(" "),

    --cfg:stLabel("NLP_EN:"),
	--cfg:enumView(dms_flexible_global.dms_aec_mode.nlp_en),
    --cfg:stLabel(" "),

    cfg:stLabel("ANS_EN:"),
	cfg:enumView(dms_flexible_global.dms_aec_mode.ans_en),
    cfg:stLabel(" "),

    cfg:stLabel("ENC_EN:"),
	cfg:enumView(dms_flexible_global.dms_aec_mode.enc_en),
    cfg:stLabel(" "),

    cfg:stLabel("AGC_EN:"),
	cfg:enumView(dms_flexible_global.dms_aec_mode.agc_en),
    cfg:stLabel(" "),
...
-- 5-5) dms_ndt_max_gain
dms_flexible_global.agc.dms_ndt_max_gain.cfg = cfg:dbf("DMS_FLEXIBLE_NDT_MAX_GAIN:  ", 12.0);
...
dms_flexible_global.agc.dms_ndt_max_gain.hbox_view = cfg:hBox {
    cfg:stLabel("NDT_MAX_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_flexible_global.agc.dms_ndt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};

-- 5-6) dms_ndt_min_gain
dms_flexible_global.agc.dms_ndt_min_gain.cfg = cfg:dbf("DMS_FLEXIBLE_NDT_MIN_GAIN:  ", 0.0);
...
dms_flexible_global.agc.dms_ndt_min_gain.hbox_view = cfg:hBox {
    cfg:stLabel("NDT_MIN_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_flexible_global.agc.dms_ndt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
dms_flexible_global.agc.dms_dt_max_gain.hbox_view = cfg:hBox {
    cfg:stLabel("DT_MAX_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_flexible_global.agc.dms_dt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};
...
dms_flexible_global.agc.dms_dt_min_gain.hbox_view = cfg:hBox {
    cfg:stLabel("DT_MIN_GAIN:  " .. TAB_TABLE[1]),
    cfg:dspinView(dms_flexible_global.agc.dms_dt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
-- 2) ble_name
local ble_name = cfg:str("BLE 蓝牙名字", "AC700N-BLE");
