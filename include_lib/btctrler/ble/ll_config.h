...
#define VENDOR_BB_MD_CLOSE              BIT(0)
#define VENDOR_BB_CONNECT_SLOT          BIT(1)
#define VENDOR_BB_NEW_SCAN_STRATEGY		BIT(2)
#define VENDOR_BB_WL_COEX_ROLE_EN       BIT(3)
#define VENDOR_BB_WL_COEX_ROLE          BIT(4)
