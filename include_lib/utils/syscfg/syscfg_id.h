...
//=================================================================================//
//60可使用
#define    CFG_REMOTE_DB_INFO          61 //可使用
...
#define    CFG_TWS_REMOTE_ADDR         87 //可使用
#define    CFG_TWS_COMMON_ADDR         88 //可使用
...
#if WIFI_STA_INFO_IDX_END >= WIFI_PMK_INFO
#error "NETWORK_SSID_INFO_CNT TOO LARGE"
#endif
#define    WIFI_CHANNEL_INFO            191
