...
int system_clock_hsb_lsb_div(u8 hsb_div1_4, u8 lsb_div1_8);//与system_clock_hsb_lsb_div_resume成对使用,hsb_clk = sys_pll / hsb_div1_4,lsb_clk = sys_pll / hsb_div1_4 / lsb_div1_8
void system_clock_hsb_lsb_div_resume(int div);//与system_clock_hsb_lsb_div成对使用
#endif
